    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if(user == null)
                    {
                        ...
                        user = new ApplicationUser { UserName = model.UserName,  Email = model.Email,  PhoneNumber = model.PhoneNumber  };
        ...
        public string GetUserList([FromBody]RequestObject requestObject)
        {
            ...
            try
            {
                ...
                if (Role == "All")
                {
                    users = _context.Users.Skip(skip).Take(take).Include(u=>u.Roles).ToArray();
